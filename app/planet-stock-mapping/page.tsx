...
export default function PlanetStockMappingPage() {
  ...
  function toggleStock(stock: Stock, sector: string) {
  ...
  function toggleSector(sector: string, stocks: Stock[]) {
